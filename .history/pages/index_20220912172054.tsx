...
const Home: NextPage = () => {
  ...
  if (isLoading)
    return (
      <div className="bg-[#251737] h-screen flex flex-col items-center justify-center">
    ...
    <div className="bg-[#251737] min-h-screen flex flex-col">
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-between p-5">
        ...
        <p className="text-xs text-emerald-900 pr-5">
            This App was built using Next, Tyepscript and TailwindCSS. Log in capabilites through MetaMask was ach       
        </p>
      </footer>
    </div>
  );
